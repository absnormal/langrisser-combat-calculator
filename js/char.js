...
var char = [{
    ...
    TALENTNAME: '魔神之力',
    TALENT: '治療量增加20%。<br>範圍技能會令命中的所有格子獲得2回合的特殊效果[生命之息]：“當友軍單位移動至其上，在行動結束時驅散自身1個弱化效果，並治療生命值，治療量為麗可麗絲智力的1倍。',
    JOB1:'魔王化身', ARMY1: '魔物',
    ...
    TALENTNAME: '魔導容器',
    TALENT: '造成傷害提升30%。<br>主動造成傷害以後，在回合結束時驅散3格內其他友軍部隊2個弱化效果，並治療生命值，治療量為蕾伽爾智力的3倍。',
    JOB1:'魔能核心', ARMY1: '法師',
    ...
    TALENTNAME: '華麗獨舞',
    TALENT: '普通攻擊時，英雄的射程增加1。<br>每損失一個士兵，則獲得攻擊、技巧提升4%的效果。',
    JOB1:'光武·改', ARMY1: '騎兵',
    JOB1DISCA:'部隊血量100%時，遭受傷害降低10%。',
    ...
    TALENTNAME: '天才軍師',
    TALENT: '使用輔助技能時射程增加2。<br>士兵全屬性提升20%。<br>英雄死亡時，驅散5格以內所有友軍2個弱化效果，並獲得“死守”：戰前恢復威拉智力5倍的生命，持續3回合。',
    JOB1:'軍師', ARMY1: '僧侶',
    JOB1DISCA:'部隊血量100%時，遭受傷害降低10%。',
    ...
    TALENTNAME: '森林眷屬',
    TALENT: '每移動1格，造成傷害、暴擊率提升4%。（最高20%）<br>通過防禦地形時，可以獲得4格免除移動力降低的機會。',
    JOB1:'狼騎統帥', ARMY1: '弓兵',
    ...
    TALENTNAME: '異星之力',
    TALENT: '每對一名敵軍造成傷害後，可以獲得一個“異星之力”:除生命以外全屬性提升4%，可累積，最高可以累積7個。<br>行動結束時，若擁有7個“異星之力”，可以額外行動1次，並在此次行動結束時，將自己傳送至距離最近的友軍身邊，並將身上所有“異星之力”效果清除。',
    JOB1:'劍聖', ARMY1: '劍兵',
    ...
    TALENTNAME: '灰之騎士',
    TALENT: '使用技能後，恢復20%生命，並且除生命以外全屬性提升4%，可以累積，最高可以累積5個。<br>當友軍死亡時，所有技能冷卻時間減少1回合。並進入[鬼人]狀態：“傷害提升30%，遭受傷害降低30%，移動力+1，並在對敵方部隊造成傷害後，對其施加1個隨機的弱化效果”，持續2回合。若已經處於[鬼人]狀態下，則此效果替換為延長[鬼人]狀態時間2回合。[鬼人]狀態結束後，獲得“無法使用主動技能”，持續2回合。（若已經死亡超過2名以上友軍時，[鬼人]狀態變為永久持續）（該效果不可免疫和驅散）',
    JOB1:'劍聖', ARMY1: '劍兵',
