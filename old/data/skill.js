...
var skill = [{
    ...
    MIDRATE: function(side){
        run = combat.run;
        if(run < 5) return [0, 0, 0, 0, 0, 0, 0, 0.15, 0, 0, 0];
        else if(run > 0) return [0, 0, 0, 0, 0, 0, 0, 0.03*run, 0, 0, 0];
    },
    DISC: '[物理傷害]攻擊單個敵軍，造成1.2倍的傷害。進入戰鬥前每移動1格，傷害提升3%（最大15%），大於或等於10格時，此次攻擊無視護衛。'
/*           */
/* 3C 分界線 */
/*           */
},{
    ...
    TYPE: '魔法傷害', CD: 1, RANGE: '2格', AREA: '單體',
    RATE: 1.5, COUNTER: ['步兵'],
    DISC: '[魔法傷害]攻擊單個敵軍，造成1.5倍傷害，對「步兵」有特效。攜帶近戰士兵時，士兵也會同時進行攻擊。（該技能不會受到近戰傷害減免影響）'
},{
    NAME: '炎弒‧滅', COST: 3,
    TYPE: '物理傷害', CD: 4, RANGE: '1格', AREA: '單體',
    RATE: 1.8, COUNTER: ['無'],
    DISC: '[物理傷害]攻擊單個敵軍，造成1.8倍傷害，戰前驅散敵軍5個強化狀態。如果目標擁有[破滅的炎紋]則此次攻擊無法被護衛。並使炎殺幻境的冷卻時間變為4回合。'
},{
    NAME: '聖王烈擊', COST: 2,
    TYPE: '物理傷害', CD: 3, RANGE: '1格', AREA: '單體',
    RATE: 1.4, COUNTER: ['無'],
    DISC: '[物理傷害]攻擊單個敵軍，造成1.4倍傷害，並造成[位移]效果:將目標撞開2格。戰後恢復傷害數值50%的生命，可再移動2格。'
},{
    NAME: '聖怒直擊', COST: 3,
    TYPE: '物理傷害', CD: 6, RANGE: '1格', AREA: '單體',
    RATE: 1.8, COUNTER: ['無'],
    DISC: '[物理傷害]攻擊單個敵軍，造成1.8倍傷害。戰前驅散敵軍3個強化狀態。並造成[位移]效果:將目標撞開3格。攻擊被護衛時，傷害額外提升15%，且行動結束時獲得[聖怒]：「造成傷害提升20%，攻擊時無視護衛，使用技能造成傷害後使自身所有技能冷卻時間減少3回合」，持續1回合。（[聖怒]效果無法免疫和驅散）'
},{
    NAME: '聖光', COST: 1,
    TYPE: '魔法傷害', CD: 1, RANGE: '2格', AREA: '單體',
    RATE: 1.4, COUNTER: ['魔物'],
    DISC: '[魔法傷害]攻擊單個敵軍，造成1.4倍傷害，對「魔物」有特效。戰後為生命最低的友軍恢復生命。恢復量為施法者智力的2倍。'
},{
    NAME: '聖耀', COST: 2,
    TYPE: '魔法傷害', CD: 2, RANGE: '2格', AREA: '單體',
    RATE: 1.5, COUNTER: ['魔物'],
    DISC: '[魔法傷害]攻擊單個敵軍，造成1.5倍傷害，對「魔物」有特效。戰後令命中的格子及其周圍1格獲得2回合的特殊效果[聖耀]:"當敵軍單位移動至其上，在行動結束時，驅散1個強化效果。'
},{
    NAME: '聖光之擁', COST: 3,
    TYPE: '魔法傷害', CD: 5, RANGE: '2格', AREA: '單體',
    RATE: 1.5, COUNTER: ['步兵','槍兵','騎兵','法師','魔物','飛兵','弓兵','刺客','水兵'], COUNTERRATE: 0.2,
    DISC: '[魔法傷害]攻擊單個敵軍，造成1.5倍傷害，對「僧侶」以外部隊有特效。戰後為全體其他友軍恢復生命值，恢復量為自身智力的2倍。行動結束時，使自身和相鄰的隨機1名友軍獲得[聖盾]：「生命值100%時，遭受傷害降低25%」，持續1回合。'
}];
