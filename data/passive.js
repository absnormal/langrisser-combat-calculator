var passive = [{
    ...
    NAME: '看破',
    TYPE: ['艾爾文', 'SP艾爾文','銀狼','萊恩哈特','伊梅爾達','迪哈爾特','飛影','艾絲蒂爾','路因','阿倫'],
    CRITRATEINC: 0.1,
    ...
    NAME: '警戒',
    TYPE: ['格尼爾','亞爾緹娜','神崎堇','古巨拉','歐米伽','維拉玖','戶愚呂兄弟','利亞特'],
    ODEF: 0.12,
    ...
    NAME: '重盾',
    TYPE: ['桑原和真','伊露希亞','艾馬林克','艾絲蒂爾','巴恩哈特','巴爾加斯','芙蕾雅', 'SP芙蕾雅'], offINDEX:1, defINDEX: 1,
    DATA: [0, 0, 1], MAX: 2,
    SKILLTYPE: ['MIDRATE'],
    MIDRATE: function(side){
        if(side == 'offense') oppDMGTYPE = combat.defDMGTYPE, range = combat.range;
