var passive = [{
    ...
    NAME: '再移動',
    TYPE: ['馬修-突擊騎士','奧利佛','蘭迪烏斯','傑利奧魯&蕾拉','迪哈爾特','露娜','艾馬林克','布琳達'],
    ODMGINC: 0.1,
    ...
    NAME: '堅守',
    TYPE: ['帕恩','艾拉斯卓','弗洛朗蒂婭','蘭芳特','亞魯特繆拉','維拉','真宮寺櫻','法娜','羅莎莉婭','桑原和真','尤莉婭'],
    ODEF: 0.07, DDEF: 0.07,
    DESC: '[被動]進入戰鬥時，防禦提升7%。'
},{
    NAME: '增援',
    ...
    NAME: '看破',
    TYPE: ['艾爾文','銀狼','萊恩哈特','伊梅爾達','迪哈爾特','飛影','艾絲蒂爾'],
    CRITRATEINC: 0.1,
    ...
    NAME: '致命',
    TYPE: ['雷因法魯斯','娜姆','霧風','歐米伽'],
    OATK: 0.12,
    DESC: '[被動]主動攻擊進入戰鬥時，攻擊提升12%。'
},{
    NAME: '警戒',
    TYPE: ['格尼爾','亞爾緹娜','神崎堇','古巨拉','歐米伽','維拉玖','戶愚呂兄弟'],
    ODEF: 0.12,
