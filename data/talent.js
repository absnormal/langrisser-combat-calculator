...
var talent = [{
    ...
    ODMGINC: 0.25,
    ODEF: 0.25,
    DESC: '主動攻擊時，造成傷害和防禦提升25%。自身2格範圍沒有友軍時無法被一擊致命（每場戰鬥最多觸發1次）.。進入戰鬥前每移動1格，戰前恢復自身20%生命，大於等於4格時會先於敵軍進行攻擊。',
},{
    NAME: '劍刃領域',
    AOEDMGDEC: 0.3,
...
/*            */
    ...
    TALENTDMGDEC: 0.15,
    CRITRATEDEC: 0.3,
    DESC: '遭受傷害降低15%，遭受暴擊率降低30%。周圍2格範圍內，所有敵軍造成傷害前100%的概率受到1次芙蕾亞"防禦"+"魔防"1倍的[固定傷害]，如果敵軍為[混合部隊]，則此次傷害無法被免疫。',
},{
    /* 乘算 */
    NAME: '勇將的神力',
    SKILLTYPE: ['MIDRATE'],
