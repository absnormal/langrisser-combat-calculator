...
var skill = [{
    ...
    NAME: '風刃', COST: 1,
    TYPE: '魔法傷害', CD: 1, RANGE: '2格', AREA: '單體',
    RATE: 1.5, COUNTER: ['飛兵'], COUNTERRATE: 0.6,
    ...
    NAME: '暗物質', COST: 2,
    TYPE: '魔法傷害', CD: 3, RANGE: '2格', AREA: '單體',
    RATE:  1.5, COUNTER: ['無'],
    ...
    NAME: '斷現', COST: 2,
    TYPE: '魔法傷害', CD: 1, RANGE: '2格', AREA: '單體',
    RATE:  1.5, COUNTER: ['無'], SOLDATK: '無',
    /* FIRST ATTACK */
    CRITRATEINC: 0.15,
    DISC: '[魔法傷害]攻擊單個敵軍，造成1.5倍傷害，暴擊率提升15%。進入戰鬥前，會先於敵軍進行攻擊。'
},{
    NAME: '漆黑之慾', COST: 2,
    TYPE: '物理傷害', CD: 4, RANGE: '1格', AREA: '單體',
    RATE:  1.4, COUNTER: ['無'], SOLDATK: '無',
    DISC: '[物理傷害]攻擊單個敵軍，造成1.4倍傷害。戰鬥前，用「防禦」的1.6倍代替「攻擊」，同時驅散自身最多3個弱化狀態，每驅散1個弱化狀態，則獲得10%的傷害加成，並在戰後將驅散掉的所有異常狀態附加到目標身上。(驅散的傷害加成在被動)'
},{
    NAME: '清淨投擲槍', COST: 2,
    TYPE: '物理傷害', CD: 3, RANGE: '2格', AREA: '單體',
    RATE:  1.3, COUNTER: ['無'], SOLDATK: '有',
    DISC: '[物理傷害]攻擊單個敵軍，造成1.3倍傷害。攜帶近戰士兵時，士兵也會同時進行攻擊。戰前驅散敵軍2個強化狀態，戰後使敵軍獲得[傷口詛咒]：「被施加的治療直接轉變為治療量10%的傷害」，持續1回合。'
},{
    NAME: '不淨衝擊盾', COST: 2,
    TYPE: '物理傷害', CD: 5, RANGE: '1格', AREA: '單體',
    RATE:  1.2, COUNTER: ['無'], SOLDATK: '無',
    SKILLTYPE: ['MIDRATE'],
    MIDRATE: function(side){
        run = combat.run;
        if(run < 3) return [0, 0, 0, 0, 0, 0, 0, 0.45, 0, 0, 0];
        else if(run > 0) return [0, 0, 0, 0, 0, 0, 0, 0.15*run, 0, 0, 0];
    },
    DISC: '[物理傷害]攻擊單個敵軍，造成1.2倍傷害。攻擊前每移動一格，傷害提升15%（最多提升45%）。進入戰鬥前使敵軍隨機獲得一個不可驅散的強力弱化效果，持續1回合。'
/*           */
/* 3C 分界線 */
/*           */
},{
    ...
    RATE: 1.5, COUNTER: ['步兵','槍兵','騎兵','飛兵'], COUNTERRATE: 0.2,
    ...
    TYPE: '物理傷害', CD: 5, RANGE: '1格', AREA: '單體',
    RATE:  1.7, COUNTER: ['無'],
    DISC: '[物理傷害]攻擊單個敵軍，造成1.7倍傷害。戰後使得敵軍獲得「無法被治療」和[血咒]：「行動結束時，受到一次[固定傷害]（傷害數值為自身最大生命值的15%）並恢復所有敵方部隊等量生命」，持續2回合，此技能施加的效果均不可驅散。'
},{
    NAME: '破邪', COST: 2,
    TYPE: '魔法傷害', CD: 3, RANGE: '3格', AREA: '3格',
    RATE: 0.3, COUNTER: ['魔物'],
    DISC: '[魔法傷害]暴擊率提升15%，攻擊範圍內多個敵軍，造成0.3倍的範圍傷害，並驅散1個強化狀態。對「魔物」有特效。'
}];
